<h5>Ми завжди поруч у Вашому місті. Завітайте до нас в «Ломбард Економь»
...
<div id="shtorka"></div>
  <div id="zayavka" class="dialog">
	...
	<option value="Нерухомість">Нерухомість</option>
       ...
       <input name="ctl00$TextBox6" type="text" id="ctl00_TextBox6" style="width:100px;">
       </td>
       <td>
       <label>Модель</label>
       <input name="ctl00$TextBox7" type="text" id="ctl00_TextBox7" style="width:100px;">
       </td>
       </tr>
        <tr class="odd">
       <td>
       <label>Рік випуску</label>
       <input name="ctl00$TextBox8" type="text" id="ctl00_TextBox8" class="numbersOnly" style="width:100px;">
       </td>
       <td>
       <label>Пробіг, км.</label>
       <input name="ctl00$TextBox9" type="text" id="ctl00_TextBox9" class="numbersOnly" style="width:100px;">
       </td>
       </tr>
       <tr class="even">
       <td>
       <label>Обєм двигуна, літри</label>
       <input name="ctl00$TextBox10" type="text" id="ctl00_TextBox10" style="width:100px;">
       </td>
       <td>
       <label>Коробка</label>
	...
	<option value="Варіатор">Варіатор</option>
        ...
        <td>
         ...
         <input name="ctl00$TextBox11" type="text" id="ctl00_TextBox11" style="width:100px;">
        </td>
         <td>
         <label>Модель</label>
         <input name="ctl00$TextBox12" type="text" id="ctl00_TextBox12" style="width:100px;">
        </td>
        </tr>
        <tr class="even">
        <td>
        <label>Ref-Nr</label>
        <input name="ctl00$TextBox13" type="text" id="ctl00_TextBox13" style="width:100px;">
        </td>
        <td>
        </td>
        </tr>
        ...
        <textarea name="ctl00$TextBox4" rows="2" cols="20" id="ctl00_TextBox4" onkeypress="validate()"></textarea>
  		<br>
        <label>Файл з описом предмету <em>(фотографія або архів)</em>:</label>
        <input type="file" name="ctl00$FileUpload1" id="ctl00_FileUpload1">
        <br>
        <p><em><strong>Увага!</strong> Для того щоб відправити заявку Вам необхідно заповнити усі поля.</em></p>
        <div style="display:none; text-align:center;" id="senderBtn">
        <input type="submit" name="ctl00$Button1" value="Надіслати" id="ctl00_Button1" class="button">
        </div>
  	</div>
  </div>
   <div id="calk" class="dialog">
    ...
    <label>Вкажіть суму позики в гривнях:</label>
        <input id="calk-sum" type="text" onkeyup="calk()" style="width:100px;" class="numbersOnly" value="1">
        <div style="padding-bottom:10px;">
        <p>Відсоткова ставка складає:<br><br></p>
        <span style="font-size:54px;" id="calk-p">1.0 %</span>
        </div>
    </div>
    </div>
