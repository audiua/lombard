            ...
            <div id="container">
                <div id="runtext">
                    ...
                    <marquee direction="left">
                        Раді вітати Вас на сайті мережі ломбардів «Ломбард Економ»!        Увага!!!        З 1-го липня діє дисконтна програма. Запрошуємо всіх, хто хоча би один раз обслуговувався у нас, прийти за своєю карткою. Новим клієнтам СТАРТОВА картка - в подарунок! Докладніше - в розділі "Дисконт".
                    </marquee>
                </div>
                <div id="left">
